...
CREATE TABLE `application` (
  ...
  `applicant_ID` varchar(45) DEFAULT NULL,
...
INSERT INTO `application` VALUES ('1','1850001','1','2020-09-15',8,10);
...
CREATE TABLE `chat_record` (
  ...
  `chat_time` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`teacher_id`,`student_id`,`chat_ID`),
  KEY `chat_record_student_idx` (`student_id`),
  CONSTRAINT `chat_record_student` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_ID`),
  CONSTRAINT `chat_record_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_record` VALUES ('6','1850001','1',_binary '\0','2020-09-05 17:07');
...
INSERT INTO `clockin_record` VALUES ('1650001','2020-09-05',1,'浙江','杭州'),('1650002','2020-09-05',1,'四川','成都'),('1750001','2020-09-05',1,'安徽','合肥'),('1750002','2020-09-05',1,'新疆','乌鲁木齐'),('1750003','2020-09-05',1,'浙江','宁波'),('1850001','2020-09-05',1,'浙江','温州'),('1850002','2020-09-05',1,'贵州','贵阳'),('1850003','2020-09-05',1,'湖南','长沙'),('1850004','2020-09-05',1,'辽宁','大连'),('1850005','2020-09-05',1,'青海','西宁');
...
INSERT INTO `default_record` VALUES ('1850001',1,'1','2020-09-16');
...
CREATE TABLE `facilities` (
  ...
  `facility name` varchar(45) DEFAULT NULL,
  `start_time` int DEFAULT NULL,
  `end_time` int DEFAULT NULL,
...
INSERT INTO `facilities` VALUES ('1','篮球场',8,20,100,1,7),('2','足球场',8,20,100,1,7),('3','图书馆',8,20,1000,1,7),('4','羽毛球场',8,20,20,1,7);
/*!40000 ALTER TABLE `facilities` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `facility_application`
--

DROP TABLE IF EXISTS `facility_application`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `facility_application` (
  `facility_ID` varchar(10) NOT NULL,
  `date` date NOT NULL,
  `start_time` int NOT NULL,
  `end_time` int DEFAULT NULL,
  `capacity_left` int DEFAULT NULL,
  PRIMARY KEY (`facility_ID`,`date`,`start_time`),
  CONSTRAINT `facility_application_facilities` FOREIGN KEY (`facility_ID`) REFERENCES `facilities` (`facility_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `facility_application`
--

LOCK TABLES `facility_application` WRITE;
/*!40000 ALTER TABLE `facility_application` DISABLE KEYS */;
INSERT INTO `facility_application` VALUES ('1','2020-09-15',8,10,100),('1','2020-09-15',10,12,100),('1','2020-09-15',12,14,100),('1','2020-09-15',14,16,100),('1','2020-09-15',16,18,100),('1','2020-09-15',18,20,100);
/*!40000 ALTER TABLE `facility_application` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `leaving_record` VALUES ('1850001',1,'上海外滩','2020-09-16','公交车','北安跨','2020-09-16','北安跨');
...
INSERT INTO `pandemic_situation` VALUES ('四川','成都',0,'2020-09-05'),('安徽','合肥',0,'2020-09-05'),('新疆','乌鲁木齐',1,'2020-09-05'),('浙江','宁波',0,'2020-09-05'),('浙江','杭州',0,'2020-09-05'),('浙江','温州',0,'2020-09-05'),('湖南','长沙',0,'2020-09-05'),('贵州','贵阳',0,'2020-09-05'),('辽宁','大连',1,'2020-09-05'),('青海','西宁',0,'2020-09-05');
...
INSERT INTO `quarantine_record` VALUES ('1850001','1','2020-09-01','2020-09-15','同济迎宾馆');
...
INSERT INTO `sick_leave` VALUES ('1','1850001','6','2020-09-18','2020-09-18','2020-09-19','2020-09-20');
...
INSERT INTO `student` VALUES ('1650001',1,'吴九','1234','DI','16',1601,'1-102','green','19988888888','19988888888',1),('1650002',1,'郑十','1234','SSE','16',1601,'1-506','green','19999999999','19999999999',1),('1750001',0,'赵六','1234','CAUP','17',1701,'15-309','green','19955555555','19955555555',1),('1750002',1,'孙七','1234','CAUP','17',1702,'3-511','green','19966666666','19966666666',1),('1750003',1,'周八','1234','SSE','17',1701,'3-511','green','19977777777','19977777777',1),('1850001',1,'刘一','1234','SSE','18',1801,'8-317','green','19900000000','19900000000',1),('1850002',1,'陈二','1234','SSE','18',1802,'8-318','green','19911111111','19911111111',1),('1850003',0,'张三','1234','SSE','18',1803,'19-207','green','19922222222','19922222222',1),('1850004',0,'李四','1234','SSE','18',1804,'19-317','green','19933333333','19933333333',1),('1850005',0,'王五','1234','SSE','18',1805,'19-307','green','19944444444','19944444444',1);
...
INSERT INTO `teacher` VALUES ('1','123456','张老师','CAUP','教授','13800000000'),('2','123456','赵老师','DI','副教授','13811111111'),('3','123456','王老师','IS','教授','13822222222'),('4','123456','李老师','SEE','副教授','13833333333'),('5','123456','孙老师','SESE','教授','13844444444'),('6','123456','钟老师','SSE','辅导员','13855555555');
...
INSERT INTO `usage_record` VALUES ('1850001','1','2020-09-15',10,8);
...
-- Dump completed on 2020-09-05 17:20:17
