...
namespace database.Controllers
{
    ...
    {
        [HttpPost]
        public LinkedList<return21> getStuQua([FromBody]String_1 index){
            LinkedList<return21>result=new LinkedList<return21>();
            CommonClass commonClass=new CommonClass();
            commonClass.open();    
            MySqlCommand cmd = new MySqlCommand("select * from quarantine_record where student_id="+index.student_ID, commonClass.returnConn());
