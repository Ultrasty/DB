...
namespace database.Controllers
{
    ...
    {
        [HttpPost]
        public LinkedList<return22> getStu22([FromBody]req22 trip_num){    
            LinkedList<return22> result=new LinkedList<return22>();
            CommonClass commonClass=new CommonClass();
            commonClass.open();    
            MySqlCommand cmd1 = new MySqlCommand("select student_ID,student_name,trip_num,date from back_info natural join student where trip_num='"+trip_num.trip_num+"'", commonClass.returnConn());
            ...
            commonClass.close();
            commonClass.open();
            MySqlCommand cmd2 = new MySqlCommand("select student_ID,student_name,trip_num,date from leaving_record natural join student where trip_num='"+trip_num.trip_num+"'", commonClass.returnConn());
