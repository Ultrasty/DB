...
namespace database.Controllers
{
    ...
    {
        [HttpGet]
        public LinkedList<return19> getStuQua([FromBody]string index){
            ...
            foreach(var item in result){
                commonClass.open();
                MySqlCommand insert=new MySqlCommand("insert into back_info values('"+item.student_ID+"','"+item.date+"','plane','HU7541',"+item.batch_num+", '2020-9');",commonClass .returnConn());
